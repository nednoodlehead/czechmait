...
empty_board = {
        ...
        Tile("d4"): Empty(), Tile("d5"): Empty(), Tile("d6"): Empty(),
        Tile("d7"): Empty(), Tile("d8"): Empty(), Tile("e1"): Empty(),
        Tile("e2"): Empty(), Tile("e3"): Empty(), Tile("e4"): Empty(),
        Tile("e5"): Empty(), Tile("e6"): Empty(), Tile("e7"): Empty(),
        Tile("e8"): Empty(), Tile("f1"): Empty(), Tile("f2"): Empty(),
        Tile("f3"): Empty(), Tile("f4"): Empty(), Tile("f5"): Empty(),
...
proper_testing_board = {
 ...
 # it cant detect checkmate :(
mate_in_3 = {
        Tile("a1"): Empty(), Tile("a2"): Empty(), Tile("a3"): Empty(),
        Tile("a4"): Empty(), Tile("a5"): Empty(), Tile("a6"): Empty(),
        Tile("a7"): Empty(), Tile("a8"): Rook(Black), Tile("b1"): Empty(),
        Tile("b2"): Empty(), Tile("b3"): Empty(), Tile("b4"): Empty(),
        Tile("b5"): Empty(), Tile("b6"): Empty(), Tile("b7"): Empty(),
        Tile("b8"): Empty(), Tile("c1"): Empty(), Tile("c2"): Empty(),
        Tile("c3"): Empty(), Tile("c4"): Empty(), Tile("c5"): Empty(),
        ...
        Tile("d7"): Empty(), Tile("d8"): Empty(), Tile("e1"): Empty(),
        Tile("e2"): Empty(), Tile("e3"): Empty(), Tile("e4"): Empty(),
        Tile("e5"): Bishop(White), Tile("e6"): Empty(), Tile("e7"): Empty(),
        Tile("e8"): Empty(), Tile("f1"): Empty(), Tile("f2"): Empty(),
        Tile("f3"): Empty(), Tile("f4"): Empty(), Tile("f5"): Empty(),
        Tile("f6"): Rook(White), Tile("f7"): Pawn(Black), Tile("f8"): Empty(),
        Tile("g1"): Empty(), Tile("g2"): Empty(), Tile("g3"): Empty(),
        Tile("g4"): Empty(), Tile("g5"): Empty(), Tile("g6"): Empty(),
        Tile("g7"): Empty(), Tile("g8"): Rook(Black), Tile("h1"): King(White),
        Tile("h2"): Pawn(White), Tile("h3"): Empty(), Tile("h4"): Empty(),
        Tile("h5"): Empty(), Tile("h6"): Empty(), Tile("h7"): Pawn(Black),
        Tile("h8"): King(Black),
    }
